...
const About = () => {
  ...
  return (
    <div className="h-screen w-screen bg-[#E6DDDE]">
      ...
      >
        <div className="absolute top-16 right-16 border-r border-secondary h-[540px] subpixel-antialiased animate-side-line-grow origin-top ease-in"></div>
        <div className="absolute top-16 right-16 border-t border-secondary w-[400px] subpixel-antialiased animate-top-line-grow origin-right ease-in"></div>
        ...
        <div className="max-w-[1740px] ml-[10%] flex flex-col justify-center items-center">
          ...
          <p className="font-tertiary text-secondary text-xl font-thin leading-tight ml-[-8px] subpixel-antialiased">
